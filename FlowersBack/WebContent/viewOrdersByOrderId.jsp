	...
	%>
		...
		<%
			...
			try {
				...
				String sql = "SELECT ordersId,ordersName,ordersPrice,ordersDatetime FROM orders WHERE ordersId='"+ Id + "'";
		...
		<center>
			<table border="1" width="90%">
				...
				<tr>
					...
					<td><a href="deleteOrderSuccess.jsp?id=<%=request.getParameter("category")%>">删除</a></td>
				</tr>
				<%
					}
				%>
