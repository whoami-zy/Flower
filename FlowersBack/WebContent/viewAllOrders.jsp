...
<body>
	<center>
		<%
			...
			String sql = "select ordersId,ordersName,ordersPrice,ordersDatetime from  orders";
		...
		<%
			...
			if (list_notice < pageCount) {
				out.println(" <a href=viewAllOrders.jsp?list_notice="
						+ (list_notice + 1) + ">[下一页] </a>");
			}
			...
			out.println("        ");
			out.println(" <a href=viewAllOrders.jsp?list_notice=" + 1 + ">『首页』 </a>");
			out.println("        ");
			out.println(" <a href=viewAllOrders.jsp?list_notice=" + pageCount
					+ ">『尾页』 </a>");
