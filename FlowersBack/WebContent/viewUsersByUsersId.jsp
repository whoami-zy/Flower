	...
	%>
		...
		<%
			...
			try {
				...
				String sql = "SELECT usersId,usersName,usersTureName,usersPhone,usersAddress,usersE_mail FROM users WHERE usersId='"+ Id + "'";
		...
		<center>
			<table border="1" width="90%">
				...
				<tr>
					...
					<td><%=usersAddress%></td>
					<td><%=usersEmail%></td>
					<td><a href="deleteUserSuccess.jsp?id=<%=request.getParameter("category")%>">删除</a></td>
				</tr>
				<%
					}
				%>
