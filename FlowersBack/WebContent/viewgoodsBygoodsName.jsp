	...
	%>
		...
		<%
			...
			try {
				...
				String sql = "SELECT goodsId,goodsName,goodsMaterial,goodsPackage,goodsLanguage,goodsPrice,goodsPlace,goodsHabitus FROM goods WHERE goodsName LIKE '%"+ goodsname + "%'";
