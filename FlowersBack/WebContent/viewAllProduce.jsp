...
<center>
		<h1>查看所有厂商</h1>
			...
			String sql = "SELECT produceId,produceName FROM produce";
		...
		<%
			...
			if (list_notice < pageCount) {
				out.println(" <a href=viewAllProduce.jsp?list_notice="
						+ (list_notice + 1) + ">[下一页] </a>");
			}
			...
			out.println("        ");
			out.println(" <a href=viewAllProduce.jsp?list_notice=" + 1 + ">『首页』 </a>");
			out.println("        ");
			out.println(" <a href=viewAllProduce.jsp?list_notice=" + pageCount
					+ ">『尾页』 </a>");
