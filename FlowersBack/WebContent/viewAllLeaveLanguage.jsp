...
<center>
		<%
			...
			String sql = "SELECT leaveLanguageId,leaveLanguageName,leaveLanguage,leaveLanguageTime FROM leavelanguage";
		...
		<%
			...
			if (list_notice < pageCount) {
				out.println(" <a href=viewAllLeaveLanguage.jsp?list_notice="
						+ (list_notice + 1) + ">[下一页] </a>");
			}
			...
			out.println("        ");
			out.println(" <a href=viewAllLeaveLanguage.jsp?list_notice=" + 1 + ">『首页』 </a>");
			out.println("        ");
			out.println(" <a href=viewAllLeaveLanguage.jsp?list_notice=" + pageCount
					+ ">『尾页』 </a>");
