...
<body>
	<div id="main">
		...
		<%
			...
			String sql = "SELECT goodsId,goodsName,goodsMaterial,goodsPackage,goodsLanguage,goodsPrice,goodsPlace,imageId FROM goods Where  sortName LIKE'%祝福用花%'";
	...
	<%
		...
		if (list_notice < pageCount) {
			out.println(" <a href=Blessing.jsp?list_notice="
					+ (list_notice + 1) + ">[下一页] </a>");
		}
		...
		out.println("        ");
		out.println(" <a href=Blessing.jsp?list_notice=" + 1 + ">『首页』 </a>");
		out.println("        ");
		out.println(" <a href=Blessing.jsp?list_notice=" + pageCount
				+ ">『尾页』 </a>");
