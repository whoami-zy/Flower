...
<body>
	<div id="main">
		...
		<%
			...
			String sql = "SELECT goodsId,goodsName,goodsMaterial,goodsPackage,goodsLanguage,goodsPrice,goodsPlace,imageId FROM goods Where  sortName LIKE'%家居生活%'";
		...
		<table border="1">
			...
			<tr>
				...
				<td><a href="Buy.jsp?name=<%=goodsId%>&price=<%=goodsPrice%>">购买</a></td>
			</tr>
	...
	<%
		...
		if (list_notice < pageCount) {
			out.println(" <a href=HomeLife.jsp?list_notice="
					+ (list_notice + 1) + ">[下一页] </a>");
		}
		...
		out.println("        ");
		out.println(" <a href=HomeLife.jsp?list_notice=" + 1 + ">『首页』 </a>");
		out.println("        ");
		out.println(" <a href=HomeLife.jsp?list_notice=" + pageCount
				+ ">『尾页』 </a>");
