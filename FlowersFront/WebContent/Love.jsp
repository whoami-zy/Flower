...
<body>
	<div id="main">
		...
		<%
			...
			String sql = "SELECT goodsId,goodsName,goodsMaterial,goodsPackage,goodsLanguage,goodsPrice,goodsPlace,imageId FROM goods Where  sortName='浪漫爱情'";
		...
		<table border="1">
			...
			<tr>
				...
				<td><a href="Buy.jsp?name=<%=goodsName%>&price=<%=goodsPrice%>">加入购物车</a></td>
			</tr>
	...
	<%
		...
		if (list_notice < pageCount) {
			out.println(" <a href=Love.jsp?list_notice="
					+ (list_notice + 1) + ">[下一页] </a>");
		}
		...
		out.println("        ");
		out.println(" <a href=Love.jsp?list_notice=" + 1 + ">『首页』 </a>");
		out.println("        ");
		out.println(" <a href=Love.jsp?list_notice=" + pageCount
				+ ">『尾页』 </a>");
