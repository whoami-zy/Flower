...
<div id="main">
	...
	<center>
		<%
			...
			String sql = "select ordersId,ordersName,ordersPrice,ordersDatetime from  orders WHERE status='0'";
		...
		<table border="1">
			...
			<tr>
				...
				<td><a href="addOrder.jsp?id=<%=orderdId%>">买买买</a></td>
		...
		<%
			...
			if (list_notice < pageCount) {
				out.println(" <a href=car.jsp.jsp?list_notice="
						+ (list_notice + 1) + ">[下一页] </a>");
			}

			if (list_notice > 1) {
				out.println(" <a href=car.jsp?list_notice="
						+ (list_notice - 1) + ">[上一页] </a>");
			}
			out.println("        ");
			...
			out.println("        ");
			out.println(" <a href=car.jsp?list_notice=" + 1 + ">『首页』 </a>");
			out.println("        ");
			out.println(" <a href=car.jsp?list_notice=" + pageCount
					+ ">『尾页』 </a>");
